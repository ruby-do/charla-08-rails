...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { description: @talk.description, event_id: @talk.event_id, speaker: @talk.speaker, title: @talk.title }
    end
  ...
  test "should update talk" do
    put :update, id: @talk, talk: { description: @talk.description, event_id: @talk.event_id, speaker: @talk.speaker, title: @talk.title }
    assert_redirected_to talk_path(assigns(:talk))
  end
